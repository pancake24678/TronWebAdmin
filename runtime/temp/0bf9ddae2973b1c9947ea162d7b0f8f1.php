<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"D:\share\fadmin\public/../application/admin\view\apilog\data\index.html";i:1765036938;s:58:"D:\share\fadmin\application\admin\view\layout\default.html";i:1764904031;s:55:"D:\share\fadmin\application\admin\view\common\meta.html";i:1764946205;s:57:"D:\share\fadmin\application\admin\view\common\script.html";i:1764949863;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<div class="panel" >
    <div class="panel-body">
        <div class="form-inline datefilter" role="group" aria-label="..." style="padding-bottom: 10px;">
            <a href="javascript:;" data-type="0" class="btn btn-primary btn-refresh"><i class="fa fa-refresh"></i></a>
            <a href="javascript:;" data-type="1" class="btn btn-success btn-filter">15分钟</a>
            <a href="javascript:;" data-type="2" class="btn btn-success btn-filter">30分钟</a>
            <a href="javascript:;" data-type="3" class="btn btn-success btn-filter">1小时</a>
            <a href="javascript:;" data-type="4" class="btn btn-success btn-filter">4小时</a>
            <a href="javascript:;" data-type="5" class="btn btn-success btn-filter">12小时</a>
            <a href="javascript:;" data-type="6" class="btn btn-success btn-filter">24小时</a>
            ...
            <div class="input-group " style="width: 340px;position:relative">
            ...
            <div class="tab-pane fade active in" id="one">
                ...
                <div class="row">
                    <div class="col-lg-2 col-sm-6 col-xs-6 col-xxs-12">
                        <div class="smallstat teal-bg" style="background-color:#d4c361">
