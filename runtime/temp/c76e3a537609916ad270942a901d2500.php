                        ...
                        <form role="form">
                            ...
                            <div class="form-group" id="extend-zone">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-2">
                                        <label>忽略的字段</label>
                                        <input type="text" class="form-control" name="ignorefields" placeholder="不再新增或编辑" />
                                    </div>
                                    <div class="col-xs-2">
                                        <label>排序字段</label>
                            ...
                            <div class="form-group">
                                <legend>生成命令行</legend>
                                <textarea class="form-control" data-toggle="tooltip" readonly title="如果在线执行命令失败,可以将命令复制到命令行进行执行" rel="command" rows="1" placeholder="请点击生成命令行"></textarea>
                            </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form role="form">
                            ...
                            <div class="form-group">
                                <legend>生成命令行</legend>
                                <textarea class="form-control" rel="command" readonly rows="1" placeholder="请点击生成命令行"></textarea>
                            </div>
                                ...
                                <div class="row" style="margin-top:10px;">
                                    ...
                                    <div class="col-xs-3">
                                        ...
                                        <select name="addon" class="form-control selectpicker" data-live-search="true">
                                            ...
                                            <?php $_6985f69d21868=get_addon_list(); if(is_array($_6985f69d21868) || $_6985f69d21868 instanceof \think\Collection || $_6985f69d21868 instanceof \think\Paginator): if( count($_6985f69d21868)==0 ) : echo "" ;else: foreach($_6985f69d21868 as $key=>$item): ?>
